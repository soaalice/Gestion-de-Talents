...
<div class="container">
    <div class="mt-5 mb-5">
        ...
        <h2 class="text-default mb-3"> Available Job Offers</h2>
            ...
            <tbody>
                ...
                <?php foreach ($offers as $offer): ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?page=detailOffre&&id=<?= htmlspecialchars($offer['offer_id']) ?>"><button>Voir
                                    plus</button>
                            </a>
                            <a href="index.php?page=applicationForm&id=<?= htmlspecialchars($offer['offer_id']) ?>"><button>Apply
                                </button></a>
    ...
    <div class="mb-5 mt-5">
        ...
        <h2 class="text-default mb-3"> My Applications</h2>
        <table class="table table-bordered table-striped table-hover">
            <thead class="bg-success text-white">
                <tr>
